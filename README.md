...
This page contains the R analysis code used for the above paper (authors: Elhakeem A, Hughes R, Tilling K, Cousminer D, Jackowski S, Cole T, Kwong A, Li Z, Grant S, Baxter-Jones A, Zemel B, Lawlor D) and the example analysis dataset, the files are described below:
